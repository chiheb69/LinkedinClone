          ...
          Row(
            children: [
              SizedBox(
                width: 70,
                height: 70,
                child: ClipRRect(borderRadius: BorderRadius.circular(35),child: Image.asset("assets/Chadi.jpg", fit: BoxFit.cover,)),
              ),
              const SizedBox(width: 10,),
              const Column(
                ...
                children: [
                  Text("Chadi Kammoun", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 2,),
