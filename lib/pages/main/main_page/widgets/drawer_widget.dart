                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: 90,
                        height: 90,
                        child: ClipRRect(borderRadius: BorderRadius.circular(45),child: Image.asset("assets/Chiheb.jpg")),
                      ),
                      const SizedBox(height: 10,),
                      const Text("Chiheb Kammoun", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
